...
export default {
    ...
    methods: {
        ...mapActions('AudiencesSingle', ['storeData', 'resetState', 'setName', 'setGender', 'setLocation', 'setFrom_age', 'setTo_age', 'setCompetence', 'setSocial_network', 'fetchSocialnetworksAll']),
        updateName(e) {
