...
export default {
    ...
    methods: {
        ...mapActions('AudienceInterestingsSingle', ['storeData', 'resetState', 'setAudience', 'setInteresting', 'setWeight', 'fetchAudiencesAll', 'fetchInterestingsAll']),
