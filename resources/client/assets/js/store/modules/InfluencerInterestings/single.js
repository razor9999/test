...
const actions = {
    storeData({ commit, state, dispatch }) {
        ...
        return new Promise((resolve, reject) => {
            ...
            axios.post('/api/v1/influencer-interestings', params)
                .then(response => {
                    commit('resetState')
                    resolve()
                })
    ...
    updateData({ commit, state, dispatch }) {
        ...
        return new Promise((resolve, reject) => {
            ...
            axios.post('/api/v1/influencer-interestings/' + state.item.id, params)
                .then(response => {
    ...
    fetchData({ commit, dispatch }, id) {
        axios.get('/api/v1/influencer-interestings/' + id)
            .then(response => {
                commit('setItem', response.data.data)
            })
